...
<head>
    ...
    <title>Мерданов Худайназар | Группа 241-352 | Лабораторная № А-2 | Тип B</title>
...
<body>
    <header>
        ...
        <h1>Лабораторная работа № А-2 (Тип верстки B)</h1>
    ...
    <main>
        <h2>Результаты табулирования функции (Маркированный список)</h2>
    ...
    <footer>
        <p><strong>Тип верстки:</strong> B (Маркированный список)</p>
