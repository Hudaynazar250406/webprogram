...
<head>
    ...
    <title>Мерданов Худайназар | Группа 241-352 | Лабораторная № А-2 | Вариант 16 (DO-WHILE)</title>
...
<body>
    <header>
        ...
        <h1>Лабораторная работа № А-2 (Цикл с постусловием DO-WHILE)</h1>
    ...
    <main>
        <h2>Результаты табулирования функции (цикл DO-WHILE)</h2>
        ...
        // Выполняется минимум 1 раз, проверка условия в конце
        // ============================================
        ...
        do {
            ...
            if (!$is_error) {
                // Проверка ограничений (кроме первой итерации)
                if ($i > 0 && ($f >= $max_value || $f < $min_value)) {
                    break;
                }
                $values[] = $f;
            }
        ...
        } while ($i < $encounting && ($f >= $min_value && $f < $max_value));
        ...
        echo '<h3>Статистика (DO-WHILE)</h3>';
        if (count($values) > 0) {
    ...
    <footer>
        <p><strong>Тип верстки:</strong> <?php echo $type; ?> (Цикл DO-WHILE)</p>
