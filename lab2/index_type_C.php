...
<head>
    ...
    <title>Мерданов Худайназар | Группа 241-352 | Лабораторная № А-2 | Тип C</title>
...
<body>
    <header>
        ...
        <h1>Лабораторная работа № А-2 (Тип верстки C)</h1>
    ...
    <main>
        <h2>Результаты табулирования функции (Нумерованный список)</h2>
    ...
    <footer>
        <p><strong>Тип верстки:</strong> C (Нумерованный список)</p>
